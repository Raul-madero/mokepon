...
function unirseAlJuego() {
    fetch("192.168.0.20:8080/unirse")
        .then(function (res) {
            if (res.ok) {
                res.text()
...
function seleccionarMokepon(mascotaJugador) {
    fetch(`192.168.0.20:8080/mokepon/${jugadorId}`, {
        method: "post",
        headers: {
...
function enviarAtaques() {
    fetch(`192.168.0.20:8080/mokepon/${jugadorId}/ataques`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
...
function obtenerAtaques() {
    fetch(`192.168.0.20:8080/mokepon/${enemigoId}/ataques`)
        .then(function(res) {
            if(res.ok) {
                res.json()
...
function enviarPosicion(x, y) {
    fetch(`192.168.0.20:8080/mokepon/${jugadorId}/posicion`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
